...
router.post("/", async function (req, res, next) {
  ...
  let { timeSlots, gender, numPeople, card_number, expiry, cvv ,role,metrciNo} = req.body;
  ...
  console.log("metricNo:" + metrciNo +" "+ typeof metrciNo);
  ...
  try {
    ...
    await CreateBookslot(role,date, slottime, numPeople, gender, email,metrciNo);
